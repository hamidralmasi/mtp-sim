...
private:
  ...
  bool m_alternateLinkRouting;
  bool m_sourceRouting;
  bool m_loadAwareRouting;
  bool m_reqLoadAwareRouting;

  typedef std::list<std::pair <int,Ptr<NetDevice>>> ReqToInterfaceList;
  ReqToInterfaceList m_reqToInterfaceList;

  typedef std::list<int> IndexList;
  IndexList m_indexList;

  typedef std::list<int> FlowIdList;
  FlowIdList m_flowIdList;
