...
void
TcpSocketBase::SetPaused (bool paused)
{
  Paused = paused;
  NS_LOG_INFO("Setting paused to: " << paused);
}
...
TcpSocketBase::SendPendingData (bool withAck)
{
  ...
  NS_LOG_FUNCTION ("Paused: " << Paused << "MSS: " << m_tcb->m_segmentSize);
  if (m_txBuffer->Size () == 0)
    {
  ...
  NS_LOG_INFO ("BE WHILE: " << "P: " << Paused << " FTP: " << firstTimePaused << " WPB: " << wasPausedBefore << " AW:" << availableWindow <<" SAW: " << SavedAvailableWindow << "");

  // uint32_t minWindow = 100;
  // if (Paused)
  // {
  //   if (!firstTimePaused)
  //   {
  ...
  //     SavedAvailableWindow = availableWindow;
  //   }
  //   else
  //   {
  //     wasPausedBefore = true;
  //   }
  //   if (availableWindow > minWindow)
  //   {
  //     availableWindow = minWindow;
  //   }
  // }
  // else
  // {
  ...
  //     NS_LOG_INFO("HERE1");
  //     wasPausedBefore = false;
  //     availableWindow = SavedAvailableWindow;
  //   }
  // }
  ...
  while (availableWindow > 0)
    {
      ...
      NS_LOG_INFO ("IN WHILE: " << "P: " << Paused << " FTP: " << firstTimePaused << " WPB: " << wasPausedBefore << " AW:" << availableWindow <<" SAW: " << SavedAvailableWindow << "");
